...
class CheckoutSubmit extends Checkout implements HttpPostActionInterface
{
    /**
     * @var Validator
    ...
    public function execute()
    {
        try {
            ...
            $grandTotal = $this->_getCheckout()->getQuote()->getGrandTotal();
            ...
            if ($this->session->getAddressErrors()) {
                ...
                // Fix: redirect to custom handler
                if ($paymentInstance->getMethod() === "paymentmethod") {
                    $this->_redirect('vivapayments/multishipping/start', ['grandTotal' => $grandTotal, 'orderIds' => $this->session->getOrderIds()]);
                } else {
